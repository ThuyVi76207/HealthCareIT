...
export default function PaymentOption({
  ...
  return (
    <button
      onClick={onClick}
      className={`py-3 px-4 text-lg flex items-center hover:border-black w-full ${
        currentValue === value ? "bg-[#16917c] text-white" : "bg-gray-100"
      }`}
    >
      <div className="min-w-[50px] xs:min-w-[75px] flex justify-between mr-2 xs:mr-4">
        ...
        <img
          className={`w-12 h-12 ml-3 rounded-[4px] border`}
          src={imgSrc}
          alt=""
        ></img>
      </div>
