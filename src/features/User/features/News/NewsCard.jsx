...
const NewsCard = ({ news }) => {
    ...
    return (
        <div className="news">
            <img onClick={() => handleDetailNewsOnclick()} style={{ width: "140px", height: "140px", cursor: "pointer" }} src={news.image} alt={news.name} />
            <div>
                <div className="news__overfow" >
                    <h3 className="news__title hover:text-[#16917c] cursor-pointer" onClick={() => handleDetailNewsOnclick()}>{news.name}</h3>
