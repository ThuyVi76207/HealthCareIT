    ...
    <MainLayout>
      <div className="specialty-detail">
            ...
            <div className="w-[70%] mx-auto">
              ...
              <div
                dangerouslySetInnerHTML={{
                  __html: obSpecialty.descriptionHTML,
                }}
                className="text-[15px]"
              ></div>
            </div>
        ...
        <div className="specialty-detail-container">
          <div className="specialty-detail-container__block border border-transparent">
            <div className="province-spectialty">
              <select
                className="my-4 h-[40px] focus:outline-none rounded-[5px] px-2"
