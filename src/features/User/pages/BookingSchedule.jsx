            ...
            <div>
                ...
                <div className="w-[60%] mx-auto my-3">
                    ...
                    <div className="flex justify-end">
                        <button onClick={handlePaymentOnclick} className="bg-[#27284a] hover:bg-[#16917c] text-white text-[18px] font-medium px-4 py-2 mb-12 mt-2 rounded-[5px] mx-2">{t('bookingschedule.save')}</button>
