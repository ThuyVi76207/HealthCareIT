            ...
            <div className="banner-container">
                <div className="banner-container__left">
                    ...
                    <div className="mt-[20px]">
                        <button onClick={handleLoginOnclick} className="bg-[#27284a] hover:bg-[#16917c] text-white px-[40px] py-[15px] rounded-[35px] mr-4">{t('banner.btn1')}</button>
                        <button onClick={handleRegisterOnclick} className="bg-[#27284a] hover:bg-[#16917c] text-white px-[40px] py-[15px] rounded-[35px]">{t('banner.btn2')}</button>
                    </div>
                </div>
