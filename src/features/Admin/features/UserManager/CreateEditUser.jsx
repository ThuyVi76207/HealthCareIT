      ...
      <form ref={formRef}>
        ...
        <div className="px-12 flex gap-[10%] mt-7">
          <div className="mb-4 w-[20%]">
            ...
            {error.selectedGender && (
              <span className="text-red-600">{error.selectedGender}</span>
            )}
          </div>
          <div className="w-[70%]">
            <CommonInput
        ...
        <div className="px-12 grid grid-cols-2 gap-[10%] pt-4">
          <div className="mb-4">
            ...
            {error.selectedTitle && (
              <span className="text-red-600">{error.selectedTitle}</span>
            )}
          </div>
          ...
          <div className="mb-4">
            ...
            {error.selectedRole && (
              <span className="text-red-600">{error.selectedRole}</span>
            )}
          </div>
        </div>
