...
const TimeLineCommon = ({ language, updateList, resetForm }) => {
    ...
    <div className="grid grid-cols-4">
      {listTime &&
        ...
        listTime.map((item, index) => {
          ...
          return (
            <button
              className={`border mt-4 mx-3 py-2 ${
                item.isSelected ? 'bg-yellow-300' : 'bg-white'
              }  ${language === 'vi' ? 'min-w-[110px] ' : 'min-w-[150px]'}`}
              key={index}
