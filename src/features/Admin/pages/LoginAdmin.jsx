            ...
            <div className="w-[350px]  text-white absolute bg-[#1b2342] top-[20%] left-[40%] rounded-[10px] shadow-[0_2px_10px_1px_rgba(0,0,0,0.3)]">
                ...
                <form ref={formRef}>
                    <div className="mx-6 border border-b-2 bg-[#1b2342] border-b-[#fff] border-[#526886] flex items-center rounded-[5px]">
                        <i className="text-[18px] mt-1 ml-2"><ion-icon name="mail-outline"></ion-icon></i>
                    ...
                    <div className="mx-6 mt-4 border-2  border-b-2 border-b-[#fff] border-[#526886] flex items-center rounded-[5px]">
                        <i className="text-[18px] mt-1 ml-2"><ion-icon name="lock-closed-outline"></ion-icon></i>
                        <input
                            id="password"
                            value={password}
                    ...
                    {error.password && <p className="text-red-600 mx-6">{error.password}</p>}
                </form>
                <br />
                <a href="/manager/login" className="mx-6 text-[#16917c] text-[16px] font-semibold">{t('login.forgotpassword')} ?</a>
                <div className="flex justify-center mx-6">
                    <button onClick={handleLoginOnClick} className="bg-[#16917c] w-full py-3 px-2 my-5 rounded-[5px] text-white text-[16px]">{t('login.btn')}</button>
                </div>
