  ...
  return (
    <>
      <Routes>
        <Route
          path="/"
          element={<Navigate to={`/manager/system/${userUrl}/newsmanager`} />}
        ></Route>
        <Route
          path="/admin/*"
          element={
            userProfile && userProfile.isLogin === true && <SystemAdmin />
          }
        ></Route>
        <Route
          path="/superadmin/*"
          element={
            userProfile && userProfile.isLogin === true && <SystemSuperAdmin />
          }
        ></Route>
        <Route
          path="/doctor/*"
          element={
            userProfile && userProfile.isLogin === true && <SystemDoctor />
          }
        ></Route>
        <Route
          path="/healthstaff/*"
          element={
            userProfile &&
            userProfile.isLogin === true && <SystemHealthcareStaff />
          }
        ></Route>
        <Route
          path="/user/newsmanager"
          element={<Navigate to={`/manager/system/user/not-permission`} />}
        ></Route>
